...
[role="lead"]
A caixa de diálogo Editar Definição de comando permite editar o comando selecionado.
...
* *Versão da entidade*
+
Permite que você insira o número da versão do comando no formato _major.minor.revision_ - por exemplo, 1,0.0.
