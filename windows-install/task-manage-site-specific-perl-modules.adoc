...
. *Opcional:* Verifique se a área do módulo Perl não é inicializada usando `ppm area list`.
+
*Exemplo*
...
----
. *Opcional:* Verifique se a área do módulo Perl é inicializada usando `ppm area list`.
+
*Exemplo*
...
Repo 1 added.
----
.. *Opcional:* Verifique se o repositório necessário é adicionado usando `ppm repo list`o .
+
*Exemplo*
...
Updating files in user area...done
   2 files installed
----
.. *Opcional:* Verifique se o módulo Perl necessário está instalado usando `ppm area list`o .
+
*Exemplo*
